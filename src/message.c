...
void prepare_payload_hash(BocContext_t* bc) {
    ...
    snprintf(data_context.sign_tr_context.to_sign_str, sizeof(data_context.sign_tr_context.to_sign_str), "%.*H", TO_SIGN_LENGTH, data_context.sign_tr_context.to_sign);
}
